...
var sequelize = new Sequelize(settings.db.name, settings.db.username, settings.db.password, settings.db.options);

// Load the sequelize models
settings.files.server.models.filter(function (file) {
